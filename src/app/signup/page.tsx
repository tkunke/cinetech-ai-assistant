  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch('/api/auth/signup', {
      ...
      body: JSON.stringify({
        ...
        assistantName,
        defaultGreeting,
        tokens: 100000 // Setting initial token count for the user
      }),
    });
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              <input
                ...
                required
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm"
